function Card(props) {
  ...
  return (
    <li className="elemnt">
        ...
        <button type="button" className="btn btn_type_delete" aria-label="Удалить"></button>
        <div className="elemnt__bottom-site">
          <h2 className="elemnt__title">{props.item.name}</h2>
          <div className="elemnt__like-block"> 
            <button type="button" className="btn btn_type_like" aria-label="Поставить Лайк"></button>
